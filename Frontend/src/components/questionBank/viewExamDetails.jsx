...
//                 examDetails.selectedQuestions.map((questionId, index) => {
//                   // Since selectedQuestions contains question IDs (strings), we need to find the full question object
//                   const questionObj = examQuestions?.find(
...
//                           Question may need to be loaded or may have been
//                           deleted
//                         </div>
//                       </div>
//                     );
...
//                   return (
//                     <div
//                       key={questionObj._id || questionObj.id || index}
//                       className="border border-gray-200 rounded-lg p-4"
//                     >
//                       <div className="flex justify-between items-start mb-2">
//                         <span className="text-sm font-medium text-gray-600">
...
//                     return !examDetails.selectedQuestions?.includes(questionId);
//                   })
//                   .map((question, index) => (
//                     <div
