...
//     "Can able to Submit the exam before time runs out.",
...
const Exam = () => {
  ...
  const navigateToQuestion = (questionIndex) => {
    ...
    setQuestionStatuses((prev) => ({
      ...prev,
      [questionIndex]:
        prev[questionIndex] === "not-visited" ? "current" : prev[questionIndex],
    }));
    setShowQuestionMenu(false);
  };
            ...
            {exams.map((exam) => (
              ...
              >
                ...
                <div className="px-6 pb-6">
                  <button
                    onClick={() => startExam(exam)}
                    className="w-full bg-teal-600 hover:bg-teal-700 text-white py-3 px-4 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center"
                  >
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <button
                onClick={beginExam}
                className="px-6 py-2 bg-teal-600 text-white rounded-md hover:bg-teal-700 transition-all font-medium"
              >
                Start Exam
              </button>
            </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 max-w-md w-full text-center">
          ...
          <button
            ...
            className="w-full bg-teal-600 text-white py-2 px-4 rounded-md hover:bg-teal-700 transition-all font-medium"
          >
            Back to Exams
          </button>
        </div>
