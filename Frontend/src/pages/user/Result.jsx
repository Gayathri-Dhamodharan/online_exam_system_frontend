...
//       console.log(response.data.attendedExams, " response frm exam");
//       setSelectedResult(response.data.attendedExams);
//     } catch (error) {
...
//         style={{
//           background:
//             "linear-gradient(135deg, #E6FFFA 0%, #B2F5EA 50%, #4FD1C7 100%)",
//         }}
//       >
//         <div className="max-w-4xl mx-auto">
//           <button
...
//                   <h3 className="text-lg font-semibold mb-1">Final Score</h3>
//                   <p className="text-3xl font-bold">
//                     {selectedResult.score}/{selectedResult.totalQues}
//                   </p>
...
//   // Main dashboard view
//   const currentPieData = createPieData(
//     currentResult.correctAnswers,
//     currentResult.wrongAnswers
//   );
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-teal-600 flex items-center justify-center gap-2">
                <Calendar size={16} />
                {new Date(selectedResult.startDate).toLocaleDateString()}
              </p>
            </div>
